    ...
    <div>
      <div className="eye-tracking-page">
        ...
        <p>
          ...
          screen you should look at something 20 feet away from you for a total
          of 20 seconds.{' '}
        </p>
        <p>
        ...
        <p>
          {' '}
          A timer class can be created to time each 20 minutes spent looking at
          the computer as well as time 20 seconds spent looking away from the
          computer. A notification with a sound pops up on the screen after 20
          minutes is spent looking at the computer screen, telling the user to
          look away from the computer screen and onto a faraway object for 20
          seconds. This starts a 20 second timer when the user is ready. After
          the 20 seconds is up the user will receive another sounded
          notification telling them they can look at their screen again.
        </p>
        <p>
          PyGaze: Can be used to determine whether or not the user is looking at
          their computer screen. eyetracker.sample() will return the newest
          available gaze position as an (x,y) gaze position tuple or (-1,-1) on
          an error. Eyetracker.sample() can be called repeatedly every few
        ...
        <div>
          ...
          <p>
            To prevent disturbing the user during an important period of time a
            settings page should be available where the user can customise the
            timings for the 20-20-20 rule/blink monitoring functionality or turn
            it off entirely. For example, if the user were to be in an important
            online meeting for the next hour the user can either increase the
            period of 20 minutes of screen time to longer than an hour or
            instead choose to turn the feature off and turn it back on again
            later at their own discretion. The 20 seconds of time the user
            spends looking away from the screen can be adjustable too, the user
            can increase or decrease this period of time however they wish. The
